...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'CompressedImage_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _COMPRESSEDIMAGE._serialized_start=68
  _COMPRESSEDIMAGE._serialized_end=180
